...
class Feedback:
    ...
    def __init__(self,master):
        ...
        self.logo = PhotoImage(file = 'C:\Users\Marc\Desktop\classics\dilbert-00086.gif', width = 100, height = 100)
        ...
        Label(self.frame_header, wraplength = 300, text = ("We're glad you chose Explore California for your recent adventure.  "
        ...
        Button(self.frame_content, text = 'Submit').grid(row = 4, column = 0, padx = 5, sticky = 'e')
        Button(self.frame_content, text = 'Clear').grid(row = 4, column = 1, padx = 5, sticky = 'w')
